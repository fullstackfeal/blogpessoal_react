...
function Cadastro() {
  ...
  async function cadastrarNovoUsuario(e: FormEvent<HTMLFormElement>) {
    ...
    if (confirmarSenha === usuario.senha && usuario.senha.length >= 8) {
      ...
      ToastAlerta("Os dados do Usuário inconsistentes! Verifique as informações do cadastro.", "erro")
  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold">
        ...
        <form
          className="flex justify-center items-center flex-col w-1/2 gap-7 "
          onSubmit={cadastrarNovoUsuario}
        >
          <h2 className="text-slate-900 text-xl">Cadastrar</h2>
          ...
          <div className="flex justify-around w-full gap-8">
            <button
              type="reset"
              className="rounded text-white bg-red-400 hover:bg-red-700 w-1/2 ру-2"
              onClick={retornar}
            >
              Cancelar
            </button>
